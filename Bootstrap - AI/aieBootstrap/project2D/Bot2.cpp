...
int CalcHeuristic2(AStarNode* pNode, AStarNode* pEnd)
{
...
Bot2::Bot2(GridNode** ppGrid)
{
	m_ppGrid = ppGrid;

	m_pAStar = new AStar(GRID_SIZE * GRID_SIZE);

	m_pAStar->SetHeuristic(CalcHeuristic2);
...
void Bot2::BotDraw(Renderer2D* m_Renderer)
{
...
void Bot2::onEnter() {}
void Bot2::EnUpdate(float deltaTIme, Entity* Agent) {}
void Bot2::onDraw(Renderer2D* renderer2D) {}
void Bot2::onExit() {}